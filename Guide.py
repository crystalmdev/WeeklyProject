...
# 페이지 설정
st.set_page_config(page_title="Korea Travel Dashboard Guide", page_icon="📘", layout="wide")
...
st.markdown("""
            ...
            - **Plan Your Trip Effectively**: Access all the logistical information in one place.
            - **Get Inspired**: Watch videos and browse through photo galleries to see what awaits you in Korea.
...
with st.container():
    ...
    with row1_col1:
        ...
        st.markdown("<span style='font-size:18px;'>"
                    "Click on any section to expand and explore in-depth information about each tourist spot.</span>",
                    unsafe_allow_html=True)

    with row1_col2:
        st.image("./img/select1.png", width=400, caption="Choose your destination")

    with row2_col1:
        st.markdown("### 2. Explore Attractions")
        st.markdown("<span style='font-size:18px;'>Each region features up to 5 top attractions.</span>",
                    unsafe_allow_html=True)
...
with col2:
    ...
    st.markdown("""
                ...
                of a categorical variable across different categories. It helps users to easily grasp the relative 
                proportions of each category within the dataset.""")
...
with col3:
    ...
    st.markdown("""
                ...
                interpret the sentiment of customer feedback more intuitively.
                """)
...
with col1:
    ...
    st.markdown("Click on any section to expand and explore in-depth information about each tourist spot.")
